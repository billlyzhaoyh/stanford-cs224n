...
class NMT(nn.Module):
    ...
    def __init__(self, word_embed_size, hidden_size, vocab, dropout_rate=0.3, no_char_decoder=False):
        ...
        self.decoder=nn.LSTMCell(input_size=hidden_size+word_embed_size, hidden_size=hidden_size, bias=True)
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[
        ...
        enc_raw, (last_hidden, last_cell)=self.encoder(X_packed)
        enc_hiddens=nn.utils.rnn.pad_packed_sequence(enc_raw)[0].permute(1,0,2)
